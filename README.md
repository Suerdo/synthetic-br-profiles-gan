...
Use o formato abaixo como base e substitua os campos do autor conforme a versão final do TCC/artigo:

```bibtex
@misc{synthetic_br_profiles_gan_2026,
  title  = {Geração de Dados Sintéticos com IA Generativa: Inovação Segura e Governança Alinhadas à LGPD e ao ECA Digital},
  author = {Sobrenome, Nome},
  year   = {2026},
  note   = {Trabalho de Conclusão de Curso / artigo científico},
  url    = {https://github.com/usuario/synthetic-br-profiles-gan}
}
```
